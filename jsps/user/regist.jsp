...
<html>
  <head>
	...
	<script type="text/javascript" src="<c:url value='/jsps/jquery/jquery-1.5.1.js'/>"></script>

    <!-- 	/shopping/WebRoot/jsps/jquery/jquery-1.5.1.js   路径弄错！-->
...
<form action="<c:url value='/UserServlet'/>" method="post" id="registForm">
    ...
    <table id="tableForm">
      ...
      <tr>
        <td></td>
        <td>
          <div id="divVerifyCode"><image id="imgVerifyCode" onclick="change();" src="<c:url value='/VerifyCodeServlet'/>"/></div>
        </td>
        <td>
